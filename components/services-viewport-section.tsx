  ...
  <div className="w-full h-full bg-gradient-to-br from-gray-900 to-black rounded-2xl border border-gray-700 p-6 relative overflow-hidden">
    ...
    <div className="relative z-10 h-full flex flex-col">
      <div className="flex items-center justify-between mb-2 sm:mb-4">
        ...
        <div className="text-xs text-gray-500">notfun.ltd</div>
      </div>
      <div className="flex-1 space-y-2 sm:space-y-3">
        <div className="h-4 sm:h-8 bg-gradient-to-r from-blue-500 to-cyan-400 rounded opacity-80" />
        <div className="grid grid-cols-3 gap-1 sm:gap-2">
          <div className="h-8 sm:h-16 bg-gray-700 rounded" />
          <div className="h-8 sm:h-16 bg-gray-700 rounded" />
          <div className="h-8 sm:h-16 bg-gray-700 rounded" />
        </div>
        <div className="space-y-1 sm:space-y-2">
          <div className="h-1 sm:h-2 bg-gray-600 rounded w-full" />
          <div className="h-1 sm:h-2 bg-gray-600 rounded w-3/4" />
          <div className="h-1 sm:h-2 bg-gray-600 rounded w-1/2" />
        </div>
      </div>
      ...
      <div className="absolute bottom-0 left-0 right-0 opacity-30">
        ...
        <div className="absolute bottom-0 left-0 right-0 flex items-end justify-between px-1">
          <div className="w-6 h-16 bg-gradient-to-t from-blue-600/40 to-cyan-500/20 rounded-t-sm" />
          <div className="w-4 h-20 bg-gradient-to-t from-blue-500/40 to-cyan-400/20 rounded-t-sm" />
          <div className="w-8 h-24 bg-gradient-to-t from-blue-600/40 to-cyan-500/20 rounded-t-sm" />
          <div className="w-5 h-18 bg-gradient-to-t from-blue-500/40 to-cyan-400/20 rounded-t-sm" />
          <div className="w-7 h-28 bg-gradient-to-t from-blue-600/40 to-cyan-500/20 rounded-t-sm" />
          <div className="w-3 h-22 bg-gradient-to-t from-blue-500/40 to-cyan-400/20 rounded-t-sm" />
          <div className="w-9 h-32 bg-gradient-to-t from-blue-600/40 to-cyan-500/20 rounded-t-sm" />
          <div className="w-4 h-26 bg-gradient-to-t from-blue-500/40 to-cyan-400/20 rounded-t-sm" />
        </div>
      </div>
      ...
      <div className="absolute bottom-0 left-0 right-0 flex items-end justify-between px-1 opacity-80">
        ...
        <div className="relative">
          ...
          <div className="absolute bottom-24 left-1 w-1 h-1 bg-white rounded-full shadow-sm shadow-white hidden sm:block" />
          ...
          <div className="absolute bottom-24 right-1 w-1 h-1 bg-white rounded-full shadow-sm shadow-white hidden sm:block" />
        </div>

        <div className="w-3 h-18 sm:h-36 bg-gradient-to-t from-blue-400 to-cyan-300 rounded-t-sm" />
        <div className="w-4 h-16 sm:h-32 bg-gradient-to-t from-blue-500 to-cyan-400 rounded-t-sm" />
        <div className="w-2 h-13 sm:h-26 bg-gradient-to-t from-blue-400 to-cyan-300 rounded-t-sm" />
        <div className="w-4 h-19 sm:h-38 bg-gradient-to-t from-blue-500 to-cyan-400 rounded-t-sm" />
        <div className="w-3 h-15 sm:h-30 bg-gradient-to-t from-blue-400 to-cyan-300 rounded-t-sm" />
        ...
        <div className="relative">
          ...
          <div className="absolute bottom-24 left-1 w-1 h-1 bg-white rounded-full shadow-sm shadow-white hidden sm:block" />
          <div className="absolute bottom-28 left-1 w-1 h-1 bg-white rounded-full shadow-sm shadow-white hidden sm:block" />
          <div className="absolute bottom-32 left-1 w-1 h-1 bg-white rounded-full shadow-sm shadow-white hidden sm:block" />
          <div className="absolute bottom-36 left-1 w-1 h-1 bg-white rounded-full shadow-sm shadow-white hidden sm:block" />
          <div className="absolute bottom-40 left-1 w-1 h-1 bg-white rounded-full shadow-sm shadow-white hidden sm:block" />
          <div className="absolute bottom-4 right-1 w-1 h-1 bg-white rounded-full shadow-sm shadow-white" />
          <div className="absolute bottom-8 right-1 w-1 h-1 bg-white rounded-full shadow-sm shadow-white" />
          <div className="absolute bottom-12 right-1 w-1 h-1 bg-white rounded-full shadow-sm shadow-white" />
          <div className="absolute bottom-16 right-1 w-1 h-1 bg-white rounded-full shadow-sm shadow-white" />
          ...
          <div className="absolute bottom-24 right-1 w-1 h-1 bg-white rounded-full shadow-sm shadow-white hidden sm:block" />
          <div className="absolute bottom-28 right-1 w-1 h-1 bg-white rounded-full shadow-sm shadow-white hidden sm:block" />
          <div className="absolute bottom-32 right-1 w-1 h-1 bg-white rounded-full shadow-sm shadow-white hidden sm:block" />
          <div className="absolute bottom-36 right-1 w-1 h-1 bg-white rounded-full shadow-sm shadow-white hidden sm:block" />
        </div>

        <div className="w-3 h-17 sm:h-34 bg-gradient-to-t from-blue-400 to-cyan-300 rounded-t-sm" />
        <div className="w-2 h-11 sm:h-22 bg-gradient-to-t from-blue-500 to-cyan-400 rounded-t-sm" />
        <div className="w-4 h-21 sm:h-42 bg-gradient-to-t from-blue-400 to-cyan-300 rounded-t-sm" />
        <div className="w-3 h-14 sm:h-28 bg-gradient-to-t from-blue-500 to-cyan-400 rounded-t-sm" />
        <div className="w-3 h-16 sm:h-32 bg-gradient-to-t from-blue-500 to-cyan-400 rounded-t-sm" />
        <div className="w-2 h-12 sm:h-24 bg-gradient-to-t from-blue-400 to-cyan-300 rounded-t-sm" />
