...
export function TypingHero() {
  ...
  return (
    <div className="flex flex-col items-center w-full">
      ...
      <h1
        className={`text-2xl sm:text-7xl 2xl:text-8xl font-bold tracking-tight drop-shadow-lg w-full ${inter.className}`} // Уменьшаю размер с text-3xl до text-2xl для мобильных
      >
