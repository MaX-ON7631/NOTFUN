          ...
          <div className="p-4">
            ...
            <div className="flex items-center justify-between mb-2">
              <div className="flex items-center space-x-2">
                <img src="/images/notfun-logo-white.png" alt="NOTFUN" className="w-6 h-6" />
                <div>
            ...
            <div className="flex space-x-2">
              ...
              <button
                ...
                className="flex-1 px-3 py-1.5 bg-emerald-500 text-white rounded-md hover:bg-emerald-600 transition-all text-xs font-medium"
              >
                Schedule
              </button>
            </div>
